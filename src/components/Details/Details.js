...
function Details({channel, description, likes, timestamp, title, views,videoId,BASE_URL}) {
    const [likesCount, setLikesCount] = useState(likes);
    const handleFave = (e)=>{
        axios.put(`${BASE_URL}/videos/${videoId}`)
            .then((response)=>{
                ...
                <div className="details__dynamic">
                    ...
                    <div className="details__container">
                        <button className="details__fave" onClick={handleFave} >
                            <img src={likesIcon} alt="" className="details__icon icon"/>
                        </button>
